...
bool Shader::Load( DeviceContext * device, const char * name ) {
	...
	fileExtensions[ SHADER_STAGE_ANY_HIT ]					= "rahit";
	fileExtensions[ SHADER_STAGE_CLOSEST_HIT ]				= "rchit";
	fileExtensions[ SHADER_STAGE_MISS ]						= "rmiss";
	fileExtensions[ SHADER_STAGE_INTERSECTION ]				= "rint";
	fileExtensions[ SHADER_STAGE_CALLABLE ]					= "rcall";
	...
	for ( int i = 0; i < SHADER_STAGE_NUM; i++ ) {
		...
		//WriteFileData( nameSpirv, code, size );
