...
====================================================
*/
float ClampF( float val, float mins, float maxs ) {
	if ( val < mins ) {
		return mins;
	}
	if ( val > maxs ) {
...
====================================================
*/
float RemapRange01( float val, float mins, float maxs ) {
...
====================================================
*/
Vec3 CubeCoordToDir( int face, int u, int v ) {
	Vec3 dir = Vec3( 1, 0, 0 );
...
====================================================
*/
Vec3 CubeCoordToDir2( int face, int u, int v, int w, int h ) {
...
====================================================
*/
Vec2 PlaneRayIntersection( Vec3 dir, Vec3 norm ) {
...
====================================================
*/
void DirToCubeCoord( Vec3 dir, int & u, int & v, int & face ) {
	dir.Normalize();
...
====================================================
*/
void Vec3Ortho( const Vec3 & dir, Vec3 & u, Vec3 & v ) {
