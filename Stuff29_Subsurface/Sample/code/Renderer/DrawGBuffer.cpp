	...
	//
	{
		...
		for ( int i = 0; i < numModels; i++ ) {
			...
			if ( i < numModels - 1 ) {
				...
				descriptor.BindImage( g_imageSkullDiffuse, Samplers::m_samplerRepeat, 2 );
				descriptor.BindImage( g_imageSkullNormals, Samplers::m_samplerRepeat, 3 );
				descriptor.BindImage( g_imageSkullRoughness, Samplers::m_samplerRepeat, 4 );
